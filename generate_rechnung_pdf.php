...
try {
    ...
    <head>
        ...
        <style>
            ...
            .header { display: flex; justify-content: space-between; margin-bottom: 40px; border-bottom: 3px solid #C9A227; padding-bottom: 20px; }
            .company { text-align: left; }
            .invoice-info { text-align: right; }
            .customer { margin: 30px 0; padding: 15px; background: #f8f9fa; border-left: 4px solid #C9A227; }
    ...
    <body>
        ...
        <div class="header">
            <div class="company">
                ...
                <p>Tel: +49 123 456789<br>E-Mail: info@firma.de</p>
            </div>
            <div class="invoice-info">
                <h1 style="color: #C9A227; margin: 0;">RECHNUNG</h1>
    ...
    $html .= '<p>' . htmlspecialchars($rechnung['strasse'] ?? '') . '<br>
        ...
        <p>vielen Dank für Ihre Bestellung. Hiermit stellen wir Ihnen folgende Leistungen in Rechnung:</p>
    ...
    $html .= '</tbody>
        ...
        <div class="payment-info">
            ...
            <p><strong>Zahlungsziel:</strong> ' . date('d.m.Y', strtotime($rechnung['faelligkeitsdatum'])) . '</p>
        ...
        <p style="margin-top: 30px;">Mit freundlichen Grüßen<br><strong>Ihr Team</strong></p>
        
        <div class="footer">
            <p>Geschäftsführer: Max Mustermann | Handelsregister: HRB 12345 | USt-IdNr.: DE123456789</p>
